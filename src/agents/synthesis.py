...
Unit Economics:
- CAC: {'$' + f'{financial_model.unit_economics.cac:,.0f}' if financial_model.unit_economics.cac else 'N/A'}
- LTV: {'$' + f'{financial_model.unit_economics.ltv:,.0f}' if financial_model.unit_economics.ltv else 'N/A'}
- LTV:CAC Ratio: {f'{financial_model.unit_economics.ltv_cac_ratio:.1f}x' if financial_model.unit_economics.ltv_cac_ratio else 'N/A'}
- Payback Period: {f'{financial_model.unit_economics.payback_period_months:.0f} months' if financial_model.unit_economics.payback_period_months else 'N/A'}
- Gross Margin: {f'{financial_model.unit_economics.gross_margin:.0f}%' if financial_model.unit_economics.gross_margin else 'N/A'}
